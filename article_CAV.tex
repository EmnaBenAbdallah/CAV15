...
%%%%%%%%%%%%%%%%%%%%% DEBUT ARTICLE %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\usepackage{url}
\urldef{\mailsa}\path|{emna.ben-abdallah, olivier.roux, morgan.magnin,|
\urldef{\mailsb}\path|maxime.folschette}@irccyn.ec-nantes.fr|    
...
\and Olivier Roux \and Morgan Magnin \and Maxime Folschette }
%
...
to find the fix points, that is, the states states in which it is not possible
...
\end{abstract} \modifEB{Je pense choisir fix point}
