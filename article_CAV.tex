...
%%%%%%%%%%%%%%%%%%%%% DEBUT ARTICLE %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\usepackage{url}
\urldef{\mailsa}\path|{emna.ben-abdallah, maxime.folschette, olivier.roux,|
\urldef{\mailsb}\path| morgan.magnin}@irccyn.ec-nantes.fr|    
...
%
\author{Emna Ben Abdallah \and  Maxime Folschette
\and Olivier Roux  \and Morgan Magnin }
%
