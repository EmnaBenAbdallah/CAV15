...
Firstly, we show that starting from one PH model, it is possible to find all possible stable states (fix points \cite{wuensche1998genomic} \annotMF{Est-ce que cette ref est pertinente ? Elle me semble plutôt axée sur la notion d'attracteur}). \modifEB{Je l’ai mise car en effet je pense que le point fixe est un cas spécial des attracteurs.}
