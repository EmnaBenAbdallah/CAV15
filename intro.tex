...
Firstly, we show that starting from one PH model, it is possible to find all possible stable states (fixed points which is a specific attractor with only one state \cite{wuensche1998genomic}).
