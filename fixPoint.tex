...
we first need to translat the concerned PH network in ASP  \footnote{You can find our new methods for the dynamic verification and also the translation from PH to ASP on line: \url{https://github.com/EmnaBenAbdallah/verification-of-dynamical-properties_PH}}.
