...
\begin{tabular}{|l|c|c|c|c||c|c|c|c|c|}
  ...
  \hline
  TTR & 12 &42 & $2^{19}$ & full state & \todo{XX} & Inconc & 0m1.151s &  0m1.001s & 0m1.90s \\
  \hline
  ERBB & 20 &152 & $2^{70}$ & full state & \todo{XX}  & - &1m55.38s & 2m31.64s & 0m11.84s \\
  \hline
...
\todo{Diviser en 2 tableaux ou c'est bon??} 
