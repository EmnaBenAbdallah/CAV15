...
\annotMF{Je propose plutôt : “ASP for CTL model-checking” qui pourrait se simplifier en “ASP-CTL” dans le tableau.}
...
to the goal.
\todo{Y a-t-il moyen de les différencier de chemins corrects?}
